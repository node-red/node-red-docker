...
function docker_manifest_list_version() {
  ...
  docker manifest create ${TARGET}:${BUILD_VERSION}${NODE_VERSION}${TAG_SUFFIX} \
    ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-amd64 \
    ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-arm32v7 \
    ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-arm64v8 \
    ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-s390x

  docker manifest annotate ${TARGET}:${BUILD_VERSION}${NODE_VERSION}${TAG_SUFFIX} ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-arm32v7 --os=linux --arch=arm   --variant=v7
  docker manifest annotate ${TARGET}:${BUILD_VERSION}${NODE_VERSION}${TAG_SUFFIX} ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-arm64v8 --os=linux --arch=arm64 --variant=v8
  docker manifest annotate ${TARGET}:${BUILD_VERSION}${NODE_VERSION}${TAG_SUFFIX} ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-s390x   --os=linux --arch=s390x
...
function docker_manifest_list_beta() {
  ...
  docker manifest annotate ${TARGET}:beta${NODE_VERSION}${TAG_SUFFIX} ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-arm32v7 --os=linux --arch=arm   --variant=v7
  docker manifest annotate ${TARGET}:beta${NODE_VERSION}${TAG_SUFFIX} ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-arm64v8 --os=linux --arch=arm64 --variant=v8
  docker manifest annotate ${TARGET}:beta${NODE_VERSION}${TAG_SUFFIX} ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-s390x   --os=linux --arch=s390x
...
function docker_manifest_list_dev() {
  ...
  docker manifest annotate ${TARGET}:dev${NODE_VERSION}${TAG_SUFFIX} ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-arm32v7 --os=linux --arch=arm   --variant=v7
  docker manifest annotate ${TARGET}:dev${NODE_VERSION}${TAG_SUFFIX} ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-arm64v8 --os=linux --arch=arm64 --variant=v8
  docker manifest annotate ${TARGET}:dev${NODE_VERSION}${TAG_SUFFIX} ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-s390x   --os=linux --arch=s390x
...
function docker_manifest_list_test() {
  ...
  docker manifest annotate ${TARGET}:test${NODE_VERSION}${TAG_SUFFIX} ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-arm32v7 --os=linux --arch=arm   --variant=v7
  docker manifest annotate ${TARGET}:test${NODE_VERSION}${TAG_SUFFIX} ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-arm64v8 --os=linux --arch=arm64 --variant=v8
  docker manifest annotate ${TARGET}:test${NODE_VERSION}${TAG_SUFFIX} ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-s390x   --os=linux --arch=s390x
...
function docker_manifest_list_latest() {
  ...
  docker manifest annotate ${TARGET}:latest${NODE_VERSION}${TAG_SUFFIX} ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-arm32v7 --os=linux --arch=arm   --variant=v7
  docker manifest annotate ${TARGET}:latest${NODE_VERSION}${TAG_SUFFIX} ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-arm64v8 --os=linux --arch=arm64 --variant=v8
  docker manifest annotate ${TARGET}:latest${NODE_VERSION}${TAG_SUFFIX} ${TARGET}:${BUILD_VERSION}${NODE_VERSION:--14}${TAG_SUFFIX}-s390x   --os=linux --arch=s390x
