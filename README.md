...
Running that command should give a terminal window with a running instance of Node-RED.
        ...
        30 Apr 12:57:10 - [info] Node-RED version: v1.3.2
        30 Apr 12:57:10 - [info] Node.js  version: v14.16.1
        30 Apr 12:57:10 - [info] Linux 4.19.76-linuxkit x64 LE
        30 Apr 12:57:11 - [info] Loading palette nodes
        30 Apr 12:57:16 - [info] Settings file  : /data/settings.js
        30 Apr 12:57:16 - [info] Context store  : 'default' [module=memory]
        30 Apr 12:57:16 - [info] User directory : /data
        30 Apr 12:57:16 - [warn] Projects disabled : editorTheme.projects.enabled=false
        30 Apr 12:57:16 - [info] Flows file     : /data/flows.json
        30 Apr 12:57:16 - [info] Creating new flow file
        30 Apr 12:57:17 - [warn]
...
|----------------------------|--------|----------|------------|-------|------------------------|
| 1.3.2-14-amd64             |   14   | amd64    |   2.x 3.x  |  yes  | amd64/node:14-alpine   |
| 1.3.2-14-arm32v6           |   14   | arm32v6  |   2.x 3.x  |  yes  | arm32v6/node:14-alpine |
| 1.3.2-14-arm32v7           |   14   | arm32v7  |   2.x 3.x  |  yes  | arm32v7/node:14-alpine |
| 1.3.2-14-arm64v8           |   14   | arm64v8  |   2.x 3.x  |  yes  | arm64v8/node:14-alpine |
| 1.3.2-14-s390x             |   14   | s390x    |   2.x 3.x  |  yes  | s390x/node:14-alpine   |
| 1.3.2-14-i386              |   14   | i386     |   2.x 3.x  |  yes  | i386/node:14-alpine    |
|                            |        |          |            |       |                        |
| 1.3.2-14-minimal-amd64     |   14   | amd64    |     no     |  no   | amd64/node:14-alpine   |
| 1.3.2-14-minimal-arm32v6   |   14   | arm32v6  |     no     |  no   | arm32v6/node:14-alpine |
| 1.3.2-14-minimal-arm32v7   |   14   | arm32v7  |     no     |  no   | arm32v7/node:14-alpine |
| 1.3.2-14-minimal-arm64v8   |   14   | arm64v8  |     no     |  no   | arm64v8/node:14-alpine |
| 1.3.2-14-minimal-s390x     |   14   | s390x    |     no     |  no   | s390x/node:14-alpine   |
| 1.3.2-14-minimal-i386      |   14   | i386     |     no     |  no   | i386/node:14-alpine    |
...
|----------------------------------------|--------------------------------------------|
| latest, 1.3.2,                         | nodered/node-red:1.3.2-14-amd64            |
| latest-10, 1.3.2-14                    | nodered/node-red:1.3.2-14-arm32v6          |
|                                        | nodered/node-red:1.3.2-14-arm32v7          |
|                                        | nodered/node-red:1.3.2-14-arm64v8          |
|                                        | nodered/node-red:1.3.2-14-s390x            |
|                                        | nodered/node-red:1.3.2-14-i386             |
|                                        |                                            |
| latest-minimal, 1.3.2-minimal,         | nodered/node-red:1.3.2-14-amd64-minimal    |
| latest-14-minimal, 1.3.2-14-minimal    | nodered/node-red:1.3.2-14-arm32v6-minimal  |
|                                        | nodered/node-red:1.3.2-14-arm32v7-minimal  |
|                                        | nodered/node-red:1.3.2-14-arm64v8-minimal  |
|                                        | nodered/node-red:1.3.2-14-s390x-minimal    |
|                                        | nodered/node-red:1.3.2-14-i386-minimal     |
...
For example: suppose you are running on a Raspberry PI 3B, which has `arm32v7` as architecture. Then just run the following command to pull the image (tagged by `1.3.2-14-arm32v7`), and run the container.
```
docker run -it -p 1880:1880 -v node_red_data:/data --name mynodered nodered/node-red:latest
```

The same command can be used for running on an amd64 system, since docker discovers its running on a amd64 host and pulls the image with the matching tag (`1.3.2-14-amd64`).
...
```
docker run -it -p 1880:1880 -v node_red_data:/data --name mynodered nodered/node-red:1.3.2-14-minimal-arm32v6
