...
|:---------------------------|:------:|:--------:|:----------:|:-----:|:-----------------------------|
| 4.1.12-24                   |   24   | amd64    |    3.x     |  yes  | amd64/node:24-alpine         |
|                            |   24   | arm64v8  |    3.x     |  yes  | arm64v8/node:24-alpine       |
|                            |        |          |            |       |                              |
| 4.1.12-24-minimal           |   24   | amd64    |     no     |  no   | amd64/node:24-alpine         |
|                            |   24   | arm64v8  |     no     |  no   | arm64v8/node:24-alpine       |
|                            |        |          |            |       |                              |
| 4.1.12-debian               |   24   | amd64    |    3.x     |  yes  | amd64/node:24-trixie-slim    |
...
|----------------------------------------|--------------------------------------------|
| latest, latest-24, 4.1.12-24            | nodered/node-red:4.1.12-24                  |
| latest-24-minimal, 4.1.12-24-minimal    | nodered/node-red:4.1.12.6-24-minimal        |
...
For example: suppose you are running on a Raspberry PI 4B, which has `arm64v8` as architecture. Then just run the following command to pull the image (tagged by `4.1.12-24`), and run the container.
