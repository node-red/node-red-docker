...
Let's dissect that command:
        ...
        nodered/node-red        - the image to base it on - currently Node-RED v3.1.14
...
Running that command should give a terminal window with a running instance of Node-RED.
        ...
        10 Oct 12:57:10 - [info] Node-RED version: v3.1.14
...
|----------------------------|--------|----------|------------|-------|----------------------------|
| 3.1.14-14                   |   14   | amd64    |   2.x 3.x  |  yes  | amd64/node:14-alpine       |
...
|                            |        |          |            |       |                            |
| 3.1.14-14-minimal           |   14   | amd64    |     no     |  no   | amd64/node:14-alpine       |
...
| **Tag**                    |**Node**| **Arch** | **Python** |**Dev**| **Base Image**             |
|----------------------------|--------|----------|------------|-------|----------------------------|
| 3.1.14-16                   |   16   | amd64    |   2.x 3.x  |  yes  | amd64/node:16-alpine       |
...
|                            |        |          |            |       |                            |
| 3.1.14-16-minimal           |   16   | amd64    |     no     |  no   | amd64/node:16-alpine       |
...
| **Tag**                    |**Node**| **Arch** | **Python** |**Dev**| **Base Image**             |
|----------------------------|--------|----------|------------|-------|----------------------------|
| 3.1.14-18                   |   18   | amd64    |   2.x 3.x  |  yes  | amd64/node:18-alpine       |
...
|                            |        |          |            |       |                            |
| 3.1.14-18-minimal           |   18   | amd64    |     no     |  no   | amd64/node:18-alpine       |
...
|----------------------------------------|--------------------------------------------|
| latest, 3.1.14,                         | nodered/node-red:3.1.14-16                  |
| latest-16, 3.1.14-16                    |                                            |
|                                        |                                            |
|                                        |                                            |
| latest-minimal, 3.1.14-minimal,         | nodered/node-red:3.1.14-16-minimal          |
| latest-16-minimal, 3.1.14-16-minimal    |                                            |


| **Tag**                                | **Node-RED Base Image**                    |
|----------------------------------------|--------------------------------------------|
| latest-14, 3.1.14-14                    | nodered/node-red:3.1.14-14                  |
|                                        |                                            |
| latest-14-minimal, 3.1.14-14-minimal    | nodered/node-red:3.1.14-14-minimal          |

| **Tag**                                | **Node-RED Base Image**                    |
|----------------------------------------|--------------------------------------------|
| latest-18, 3.1.14-18                    | nodered/node-red:3.1.14-18                  |
|                                        |                                            |
| latest-18-minimal, 3.1.14-18-minimal    | nodered/node-red:3.1.14-18-minimal          
...
For example: suppose you are running on a Raspberry PI 3B, which has `arm32v7` as architecture. Then just run the following command to pull the image (tagged by `3.1.14-16`), and run the container.

```
docker run -it -p 1880:1880 -v node_red_data:/data --name mynodered nodered/node-red:latest
```

The same command can be used for running on an amd64 system, since docker discovers its running on a amd64 host and pulls the image with the matching tag (`3.1.14-16-amd64`).
...
The main sections to modify are
    ...
    "dependencies": {
        "node-red": "^3.1.14",           <-- set the version of Node-RED here
