...
Let's dissect that command:
        ...
        nodered/node-red        - the image to base it on - currently Node-RED v5.0.5
...
Running that command should give a terminal window with a running instance of Node-RED.
        ...
        10 Oct 12:57:10 - [info] Node-RED version: v5.0.5
...
|:---------------------------|:------:|:--------:|:----------:|:-----:|:-----------------------------|
| 5.0.5-24                   |   24   | amd64    |    3.x     |  yes  | amd64/node:24-alpine         |
|                            |   24   | arm64v8  |    3.x     |  yes  | arm64v8/node:24-alpine       |
|                            |        |          |            |       |                              |
| 5.0.5-24-minimal           |   24   | amd64    |     no     |  no   | amd64/node:24-alpine         |
|                            |   24   | arm64v8  |     no     |  no   | arm64v8/node:24-alpine       |
|                            |        |          |            |       |                              |
| 5.0.5-debian               |   24   | amd64    |    3.x     |  yes  | amd64/node:24-trixie-slim    |
...
|----------------------------------------|--------------------------------------------|
| latest, latest-24, 5.0.5-24            | nodered/node-red:5.0.5-24                  |
| latest-24-minimal, 5.0.5-24-minimal    | nodered/node-red:5.0.5.6-24-minimal        |
...
For example: suppose you are running on a Raspberry PI 4B, which has `arm64v8` as architecture. Then just run the following command to pull the image (tagged by `5.0.5-24`), and run the container.
...
The main sections to modify are
    ...
    "dependencies": {
        "node-red": "^5.0.5",           <-- set the version of Node-RED here
