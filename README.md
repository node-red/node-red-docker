...
|----------------------------|--------|----------|------------|-------|----------------------------|
| 3.1.13-18                   |   18   | amd64    |    3.x     |  yes  | amd64/node:18-alpine       |
...
|----------------------------------------|--------------------------------------------|
| latest, 3.1.13,                         | nodered/node-red:3.1.13-20                  |
| latest-20, 3.1.13-20                    |                                            |
|                                        |                                            |
|                                        |                                            |
| latest-minimal, 3.1.13-minimal,         | nodered/node-red:3.1.13-20-minimal          |
| latest-20-minimal, 3.1.13-20-minimal    |                                            |
|                                        |                                            |
...
| **Tag**                                | **Node-RED Base Image**                    |
|----------------------------------------|--------------------------------------------|
| latest-22, 3.1.13-22                    | nodered/node-red:3.1.13-22                  |
|                                        |                                            |
| latest-22-minimal, 3.1.13-22-minimal    | nodered/node-red:3.1.13-22-minimal          
...
For example: suppose you are running on a Raspberry PI 3B, which has `arm32v7` as architecture. Then just run the following command to pull the image (tagged by `3.1.13-20`), and run the container.
